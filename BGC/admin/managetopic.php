...
?>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="my-4 mx-4">
                    <button type="button" class="btn btn-lg btn-success"><a href="addtopic.php" class="text-white">Add Topics</a></button>
                    <button type="button" class="btn btn-lg btn-success"><a href="managetopic.php" class="text-white">Manage Topics</a></button>
                </div>
                <div>
                    <h3 class="text-center text-muted">Manage Topics</h3>
                    <div class="mx-2">
