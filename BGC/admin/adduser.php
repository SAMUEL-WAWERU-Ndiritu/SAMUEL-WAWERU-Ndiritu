    ...
    <div class="container-fluid">
        ...
        <div class="col-md-4   admin" >
                <div class="text-left  p-2 my-4 ">
                    ...
                    <a href="managepost.php" class="text-white">Manage Post</a>
                </div >
                <div class="text-left  p-2 my-4">
            ...
            <div class="col-md-8">
                ...
                <div>
                    <h3 class="text-center text-muted">Manage User</h3>
                    <div class="mx-2">
...
<div>
 ...
 <p class="my-3"> <input type="password" name="con_password" class="form-control"></p>
  ...
  <select from="role" name="role" id="role" class="form-control">
